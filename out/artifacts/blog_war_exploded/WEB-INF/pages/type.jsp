...
<div class="bug">
    <div id="bug">
        <div id="main" class="main">
            <div class="intro" id="intro">${tyname}</div>
            <article>
                <c:forEach items="${postsList}" varStatus="each" var="item">
                    <div class="post">
                        <a href="/archives/${item.id}">
                            <div class="index-img">
                                <div class="tutu">
                                    <img class="b-lazy" src="${item.fbanner}" data-src="${item.fbanner}"
                                         itemprop="image" data-no-instant/>
                                </div>
                            </div>
                        </a>
                        <h1 class="title">
                        ...
                        <div class="meta">
                            ...
                            <time itemprop="datePublished">${fn:substring(item.date, 0, 10)}</time>&nbsp; &nbsp;
